...
namespace Lean.Transition.Method
{
	...
	public class LeanGameObjectSetActive : LeanMethodWithStateAndTarget
	{
		...
		public static LeanState Register(UnityEngine.GameObject target, bool active, float duration)
		{
		...
		[System.Serializable]
		public class State : LeanStateWithTarget<UnityEngine.GameObject>
		{
...
namespace Lean.Transition
{
	...
	{
		public static GameObject SetActiveTransition(this UnityEngine.GameObject target, bool active, float duration)
		{

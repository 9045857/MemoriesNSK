...
namespace Lean.Gui
{
	...
	public class LeanSelectionManager_Inspector : LeanInspector<LeanSelectionManager>
	{
		protected override void DrawInspector()
		{
            ...
            EditorGUILayout.ObjectField("Current Selectable", EventSystem.current != null ? EventSystem.current.currentSelectedGameObject : null, typeof(UnityEngine.GameObject), false);

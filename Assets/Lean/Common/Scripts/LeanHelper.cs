	...
	public static class LeanHelper
	{
			...
			where T : Component
		{
			...
			if (parent == null || parent.GetComponentInParent<Canvas>() == null)
			{
				...
				if (canvas == null)
				{
					canvas = new UnityEngine.GameObject("Canvas", typeof(RectTransform), typeof(Canvas), typeof(CanvasScaler), typeof(GraphicRaycaster)).GetComponent<Canvas>();
					...
					{
						new UnityEngine.GameObject("EventSystem", typeof(EventSystem), typeof(StandaloneInputModule));
					}
				}
